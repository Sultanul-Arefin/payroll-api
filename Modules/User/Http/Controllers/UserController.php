        ...
        try {
            ...
            $message = DB::transaction(function () use ($request, $allFile) {
                ...
                $user_details = UserDetails::create([
                    ...
                    'tax_number' => $request->tax_number ?? $request->tax_number,
                    'social_security_number' => $request->social_security_number ?? $request->social_security_number,
                    'pension_number' => $request->pension_number ?? $request->pension_number,
                    'visa_number' => $request->visa_number ?? $request->visa_number,
                    'work_permit_number' => $request->work_permit_number ?? $request->work_permit_number,
    ...
    public function update(UserUpdateRequest $request, User $user)
    {
      ...
      //  DB::transaction(function () use ($request, $user) {
            ...
            $user_details = $this->user_repo->userDetailsUpdate($user->id, [
                ...
                'tax_number' => $request->tax_number ? $request->tax_number : $user->user_details?->tax_number,
                'social_security_number' => $request->social_security_number ? $request->social_security_number : $user->user_details?->social_security_number,
                'pension_number' => $request->pension_number ? $request->pension_number : $user->user_details?->pension_number,
