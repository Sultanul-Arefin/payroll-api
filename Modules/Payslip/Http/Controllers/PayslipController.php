...
use Modules\Payslip\Http\Resources\ViewSpainPayslipResource;
use Modules\Payslip\Http\Resources\ViewSwedishPayslipResource;
use Modules\Payslip\Http\Resources\ViewTurkeyPayslipResource;
use Modules\Payslip\Http\Resources\ViewUAEPayslipResource;
...
use Modules\Payslip\Http\Resources\ViewChinaPayslipResource;
...
class PayslipController extends Controller
{
    ...
    public function employee_salary_items_calculation(Request $request)
    {
        ...
        return CategoryResource::collection(
            ...
            'meta' => [
                'total_pay' => ($this->payslipService->getAmountForEmployee(1, $request->employee_id, $request->from_date, $request->to_date) - $this->payslipService->getAmountForEmployee(2, $request->employee_id, $request->from_date, $request->to_date)),
                'category_one_other_values' => $this->payslipService->getCategoryOneOtherValues(1, $request->employee_id, $request->from_date, $request->to_date),
                'gross_pay_before_tax' => (($this->payslipService->getAmountForEmployee(1, $request->employee_id, $request->from_date, $request->to_date)) - $this->payslipService->getAmountForEmployee(2, $request->employee_id, $request->from_date, $request->to_date)) + $this->payslipService->getAmountForEmployee(3, $request->employee_id, $request->from_date, $request->to_date),
                'gross_pay_after_tax' => ((($this->payslipService->getAmountForEmployee(1, $request->employee_id, $request->from_date, $request->to_date)) - $this->payslipService->getAmountForEmployee(2, $request->employee_id, $request->from_date, $request->to_date)) + $this->payslipService->getAmountForEmployee(3, $request->employee_id, $request->from_date, $request->to_date)) - ($this->payslipService->getAmountForEmployee(5, $request->employee_id, $request->from_date, $request->to_date) + $this->payslipService->getAmountForEmployee(6, $request->employee_id, $request->from_date, $request->to_date)),
                '7' => $this->payslipService->getAmountForEmployee(7, $request->employee_id, $request->from_date, $request->to_date), // for testing specific category value
                'pay_due_before_deduction' => (((($this->payslipService->getAmountForEmployee(1, $request->employee_id, $request->from_date, $request->to_date)) - $this->payslipService->getAmountForEmployee(2, $request->employee_id, $request->from_date, $request->to_date)) + $this->payslipService->getAmountForEmployee(3, $request->employee_id, $request->from_date, $request->to_date)) - ($this->payslipService->getAmountForEmployee(5, $request->employee_id, $request->from_date, $request->to_date) + $this->payslipService->getAmountForEmployee(6, $request->employee_id, $request->from_date, $request->to_date))) + $this->payslipService->getAmountForEmployee(4, $request->employee_id, $request->from_date, $request->to_date),
                'net_pay' => ((((($this->payslipService->getAmountForEmployee(1, $request->employee_id, $request->from_date, $request->to_date)) - $this->payslipService->getAmountForEmployee(2, $request->employee_id, $request->from_date, $request->to_date)) + $this->payslipService->getAmountForEmployee(3, $request->employee_id, $request->from_date, $request->to_date)) - ($this->payslipService->getAmountForEmployee(5, $request->employee_id, $request->from_date, $request->to_date) + $this->payslipService->getAmountForEmployee(6, $request->employee_id, $request->from_date, $request->to_date))) + $this->payslipService->getAmountForEmployee(4, $request->employee_id, $request->from_date, $request->to_date)) - $this->payslipService->getAmountForEmployee(7, $request->employee_id, $request->from_date, $request->to_date),
            ],
        ]);
    }

    public function getCategoryOneOtherValues($employee_id, $from_date, $to_date)
    {
        $overtime = 0;
        if(request('overtime')){
            $overtime = (float)request('overtime') * $this->payslipService->getSalaryItemAmount("Overtime Rate", $employee_id)->amount;
        } else{
        ...
        if(request('double_overtime')){
            $double_overtime = (float)request('double_overtime') * $this->payslipService->getSalaryItemAmount("Double Overtime Rate", $employee_id)->amount;
        } else{
        ...
        $bonus = 0;
        if(request('bonus')){
            $bonus = (float)request('bonus') * $this->payslipService->getSalaryItemAmount("Bonus", $employee_id)->amount;
        } else{
    ...
    public function run_payslip(Request $request)
    {
        ...
        $get_category_one_other_values = $this->getCategoryOneOtherValues($request->employee_id, $request->from_date, $request->to_date);
    ...
    public function preview_german_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewGermanPayslipResource($payslip), // THIS RESOURCE FILE SHOULD BE UPDATED WITH CORRECT DATA
            ]
        );
    }
    public function preview_south_african_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewSouth_AfricanPayslipResource($payslip), // THIS RESOURCE FILE SHOULD BE UPDATED WITH CORRECT DATA
            ]
        );
    }
    ...
    public function preview_australian_payslip(Payslip $payslip)
    {
        ...
        return apiResponse(
            data: [
                'user_info' => array_merge(
                    $payslip?->employee?->only(['name', 'email', 'customer_id']),
                    $payslip?->employee?->user_details?->only(['user_area', 'user_city','zip_code','gender','pension_number','visa_number','work_permit_number','uan_no','pf_no','esi_no','ni_category','national_identity_number','national_insurance_number','others_number','fax','passport','date_of_birth','bank_name','bank_bic_or_swift_code','bank_iban_or_account_no', 'state','region', 'user_phone', 'joining_date', 'social_security_number', 'tax_number','religion','pension_administrator','pension_pin','tin_number','abn_number']),
                    [
                        'employee_type' => $employee_type[$payslip?->employee?->employee_type ?? 0] ?? 'Unknown'
                    ],
                    [
    ...
    public function preview_portuguese_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                'user_info' => array_merge(
                    $payslip?->employee?->only(['name', 'email', 'customer_id']),
                    $payslip?->employee?->user_details?->only(['user_area', 'user_city','zip_code','gender','pension_number','visa_number','work_permit_number','uan_no','pf_no','esi_no','ni_category','national_identity_number','national_insurance_number','others_number','fax','passport','date_of_birth','bank_name','bank_bic_or_swift_code','bank_iban_or_account_no', 'state','region', 'user_phone', 'joining_date', 'social_security_number', 'tax_number','religion','pension_administrator','pension_pin','tin_number','abn_number','health_insurance']),
                    [
                        'employee_type' => $employee_type[$payslip?->employee?->employee_type ?? 0] ?? 'Unknown'
                    ],
                    [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewPortuguesePayslipResource($payslip), // THIS RESOURCE FILE SHOULD BE UPDATED WITH CORRECT DATA
            ]
        );
    }

    public function preview_japanese_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                'user_info' => array_merge(
                    $payslip?->employee?->only(['name', 'email', 'customer_id']),
                    $payslip?->employee?->user_details?->only(['user_area', 'user_city','zip_code','gender','pension_number','visa_number','work_permit_number','uan_no','pf_no','esi_no','ni_category','national_identity_number','national_insurance_number','others_number','fax','passport','date_of_birth','bank_name','bank_bic_or_swift_code','bank_iban_or_account_no', 'state','region', 'user_phone', 'joining_date', 'social_security_number', 'tax_number','religion','pension_administrator','pension_pin','tin_number','abn_number','health_insurance','dependent']),
                    [
                        'employee_type' => $employee_type[$payslip?->employee?->employee_type ?? 0] ?? 'Unknown'
                    ],
                    [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewJapanesePayslipResource($payslip), // THIS RESOURCE FILE SHOULD BE UPDATED WITH CORRECT DATA
            ]
        );
    }

    public function preview_spain_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewSpainPayslipResource($payslip),
                'others' => array_merge(
                    $payslip->only(['id', 'payment_date','created_at'])
                )
            ]
    ...
    public function preview_swedish_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewSwedishPayslipResource($payslip),
                'others' => array_merge(
                    $payslip->only(['id', 'payment_date','created_at'])
                )
            ]
    ...
    public function preview_turkey_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewTurkeyPayslipResource($payslip), // THIS RESOURCE FILE SHOULD BE UPDATED WITH CORRECT DATA
                'others' => array_merge(
                    $payslip->only(['id', 'payment_date','net_pay'])
                )
            ]
    ...
    public function preview_UAE_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
    ...
    public function preview_China_payslip(Payslip $payslip)
    {
        $employee_type = [
            '0' => 'No Type',
            '1' => 'FULL TIME',
        ...
        return apiResponse(
            data: [
                ...
                'company_info' => $payslip?->employee?->company?->only(['company_name', 'company_registration_no', 'company_email','company_phone','bank_bic_or_swift_code','bank_iban_or_account_no','contact_person_name','contact_person_email','contact_person_phone','bank_name','government_employee_no', 'company_website', 'company_address','subscription_duration']),
                'payslip_info' => new ViewChinaPayslipResource($payslip), // THIS RESOURCE FILE SHOULD BE UPDATED WITH CORRECT DATA
                'others' => array_merge(
                    $payslip->only(['id', 'payment_date','net_pay'])
                )
            ]
