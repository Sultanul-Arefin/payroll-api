...
class ViewFrenchPayslipResource extends JsonResource
{
    ...
    public function get_payslip_details($payslip_details){
        foreach($payslip_details as $payslip_detail){
            if($payslip_detail?->salary_item?->salaryItemsCategory?->id == 1 || $payslip_detail?->salary_item?->salaryItemsCategory?->id == 2 || $payslip_detail?->salary_item?->salaryItemsCategory?->id == 3){
