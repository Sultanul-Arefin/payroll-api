...
class ViewGermanPayslipResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
           ...
           // 'total_gross_pay' => $this->pay_due_before_deduction,
            ...
            //'Non_TaxableAllowances' => $this->NonTaxableAllowances($this->payslip_details),
            ...
            'days_present'=>$this->getTotalWorkingDaysAttribute(),
    ...
    public function get_annual_leave_calculation($employee)
    {
        return [
            ...
            'total_annual_leave_hour'=>$this->getAnnualLeaveTaken($this->employee->id)*$this->company->working_hours_per_day,
            ...
            'total_sick_leave_hour'=>$this->getSickLeaveTaken($this->employee->id)*$this->company->working_hours_per_day,
            'Absent'=>$this->getAbsentTaken($this->employee->id),
            'total_absent_leave_hour'=>$this->getAbsentTaken($this->employee->id)*$this->company->working_hours_per_day,
            // 'remaining_annual_leave' => $this->getAnnualLeaveQuota() - $this->getAnnualLeaveTaken($this->employee->id)
        ];
    }
    ...
    public function getTotalWorkingDaysAttribute()
            {
                    ...
                    return [
                        ...
                        'total_present_hour' =>$this->hours_worked,
                        //'lop_days' => $lop_days,
    ...
    public function get_other_deduction()
    {
        ...
        private function getIncomeTaxAndCategoryDetails($payslipDetails)
            ...
            // private function NonTaxableAllowances($payslipDetails)
            ...
            //     foreach ($payslipDetails as $detail) {
            //         if (in_array($detail['category_id'], [4])) { // Check if category_id is 5 or 6
            //             $filteredDetails[] = [
            //                 'pay_details' => $detail['pay_details'],
            //                 'base_amount_or_hours' => $detail['base_amount_or_hours'],
            //                 'rate' => $detail['rate'],
            ...
            //     return [
            //         'filtered_details' => $filteredDetails,
            //         'total_allowances_amount' => $totalAmount,
            //     ];
            // }
